...
void ordenarEmpleado (int[], char[][20], float[], int[], int);
...
int main()
{
    ...
    do
    {
        ...
        case 4:
            ...
            ordenarEmpleado(legajos, nombres, sueldos, estado, E);
            break;
...
void ordenarEmpleado (int legajos[], char nombres[][20], float sueldos[], int estados[], int tam)
{
    int i,j,auxInt;
    float auxFloat;
    char auxString;
